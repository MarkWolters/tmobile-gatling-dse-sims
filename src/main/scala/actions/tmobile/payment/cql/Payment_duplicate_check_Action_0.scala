...
class Payment_duplicate_check_Action_0(cassandra: Cassandra, simConfig: SimConfig)  extends BaseAction(cassandra, simConfig) {

  private val tableName = "payment_duplicate_check_0"
