...
class Payment_duplicate_check_Action(cassandra: Cassandra, simConfig: SimConfig)  extends BaseAction(cassandra, simConfig) {

  private val tableName = "payment_duplicate_check"
