...
class SearchWriteFeed extends BaseFeed with LazyLogging {
  ...
  def getRowData = {
    ...
    Map(
      ...
      "member_id_type" -> getRandomNumber(bigint_size).toString,
      ...
      "partner_id" -> getRandomNumber(bigint_size).toString,
