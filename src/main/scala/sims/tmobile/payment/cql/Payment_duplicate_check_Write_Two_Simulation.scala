...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_2
...
class Payment_duplicate_check_Write_Two_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_2(cass, simConfWrite)
