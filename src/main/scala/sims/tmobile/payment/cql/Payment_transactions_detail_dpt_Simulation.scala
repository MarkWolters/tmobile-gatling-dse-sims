...
class Payment_transactions_detail_dpt_Simulation extends BaseSimulation {
  ...
  val scenarioReadName = "Payment_transactions_detail_dpt_Simulation_Payment_Read"
  ...
  val LoadReadActions = new Payment_transactions_detail_dpt_Action(cass, simConfRead)
