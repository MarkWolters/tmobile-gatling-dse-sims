...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_1
...
class Payment_duplicate_check_Write_One_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_1(cass, simConfWrite)
