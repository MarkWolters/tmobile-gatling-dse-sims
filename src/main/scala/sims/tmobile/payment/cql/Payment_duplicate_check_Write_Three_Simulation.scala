...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_3
...
class Payment_duplicate_check_Write_Three_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_3(cass, simConfWrite)
