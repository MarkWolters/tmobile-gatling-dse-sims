...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_5
...
class Payment_duplicate_check_Write_Five_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_5(cass, simConfWrite)
