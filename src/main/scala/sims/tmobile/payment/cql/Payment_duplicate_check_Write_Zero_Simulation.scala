...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_0
...
class Payment_duplicate_check_Write_Zero_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_0(cass, simConfWrite)
