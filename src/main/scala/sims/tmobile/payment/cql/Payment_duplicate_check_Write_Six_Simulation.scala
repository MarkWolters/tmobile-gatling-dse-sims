...
import actions.tmobile.payment.cql.Payment_duplicate_check_Action_6
...
class Payment_duplicate_check_Write_Six_Simulation extends BaseSimulation {
  ...
  val LoadWriteActions = new Payment_duplicate_check_Action_6(cass, simConfWrite)
